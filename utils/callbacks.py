...
class LossHistory():
    ...
    def append_loss(self, epoch, loss, val_loss, rpn_loss, roi_loss):
        ...
        self.writer.add_scalar('rpn_loss', rpn_loss, epoch)
        self.writer.add_scalar('roi_loss', roi_loss, epoch)
        self.loss_plot()
